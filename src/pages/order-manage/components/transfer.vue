<template>
  <div class="wrapper" v-show="showTransfer">
    <div class="content">
      <p class="title">转申</p>
      <el-form ref="form" :model="form" label-width="115px" label-position="left">
        <el-form-item label="转申人">
          <el-input v-model="form.name" placeholder="请输入转申人"></el-input>
        </el-form-item>
      </el-form>
      <p class="button"><a href="javascript:;" @click="cancelTransfer">取消</a><a href="javascript:;" @click="confirmTransfer">确认</a></p>
    </div>
  </div>
</template>
