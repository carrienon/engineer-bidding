<template>
  <div class="wrapper" v-show="showOffer">
    <div class="content">
      <p class="title">重新报价</p>
      <el-form ref="form" :model="form" label-width="115px" label-position="left">
        <el-form-item label="更改价格">
          <el-input v-model="form.name" placeholder="请输入价格"></el-input>
        </el-form-item>
        <el-form-item label="更改说明">
          <el-input type="textarea" rows="5" v-model="form.desc" placeholder="请输入说明"></el-input>
        </el-form-item>
      </el-form>
      <p class="button"><a href="javascript:;" @click="cancelOffer">取消</a><a href="javascript:;" @click="confirmOffer">确认</a></p>
    </div>
  </div>
</template>
