<template>
  <div class="wrapper" v-show="showModify">
    <div class="content">
      <p class="title">发票信息</p>
      <el-form ref="form" :model="form" label-width="115px" label-position="left">
        <el-form-item label="收货地址">
          <el-input v-model="form.name" placeholder="请输入收货地址"></el-input>
        </el-form-item>
      ...
      <p class="button"><a href="javascript:;" @click="cancelModify">取消</a><a href="javascript:;" @click="confirmModify">确认</a></p>
    </div>
  </div>
</template>
