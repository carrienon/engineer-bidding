<template>
  <div class="wrapper" v-show="showDefine">
    <div class="content">
      ...
      <p class="button"><a href="javascript:;" @click="cancelDefine">取消</a><a href="javascript:;" @click="confirmDefine">确认</a></p>
    </div>
  </div>
</template>
